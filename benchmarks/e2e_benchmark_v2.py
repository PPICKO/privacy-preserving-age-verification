...
class E2EPipelineBenchmark:
        ...
        if self.config.test_image_path:
            ...
            while True:
                ...
                if dob_detected:
                    ...
                    print(f"  ✓ DOB detected with {dob_conf:.2f} confidence - verifying OCR...")
                        ...
                        if self.detection_config.CLASS_NAMES[cls_id] == "DOB":
                            ...
                            if crop.size > 0:
                                ...
                                if texts:
                                    ...
                                    if parsed:
                                        can_parse = True
                                        print(f"  ✓ OCR verified: '{cleaned}' → {parsed}")
                                        break
                                    else:
                                        print(f"  ⚠ OCR read '{cleaned}' but couldn't parse date - retrying...")
                    ...
                    if can_parse:
                        ...
                        if retry_count >= MAX_RETRIES:
                            print(f"  ✗ Max retries ({MAX_RETRIES}) reached. Using last frame anyway.")
                            captured_frame = test_frame
                            break
    ...
    def run_single_iteration(self, frame, iteration: int) -> TimingResult:
        ...
        if ocr_texts:
            ...
            if parsed_date:
                ...
                print(f"    [DEBUG] ✗ Could not parse date from: '{cleaned_text}'")
    ...
    def run_benchmark(self):
        ...
        if detected_items:
            ...
            if dob_found:
                print(f"  ✓ DOB meets threshold (≥0.80)")
            else:
